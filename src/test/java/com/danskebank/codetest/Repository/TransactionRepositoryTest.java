...
// transactionRepository.addTransaction(1, TransactionType.DEPOSIT, 100);

// assertEquals(testTransaction,
// transactionRepository.getTransaction(testTransaction.getID()));
...
// List<Transaction> expectedList = List.of(testTransaction1, testTransaction2,
// testTransaction3);
